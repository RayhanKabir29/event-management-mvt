...
from events.views import show_events,create_event,update_event,delete_event,show_categories,show_participants,crete_category,update_category,delete_category
