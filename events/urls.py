...
from events.views import show_events,create_event,update_event,delete_event,show_categories,show_participants,create_participant,crete_category,update_category,delete_category
